 ...
 */
export function extractTweetsFromBookmarksResponse(data) {
  try {
...
// Note: waitForElement() is intentionally NOT included here as it uses DOM APIs
// which are not available in service workers. It remains in helpers.js only.
